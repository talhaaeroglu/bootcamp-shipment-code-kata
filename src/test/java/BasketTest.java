...
import com.trendyol.shipment.ShipmentSizeManager;
import com.trendyol.shipment.IShipmentSizeDeterminer;
...
class BasketTest {
    ...
    @BeforeEach
    void setUp() {
        IShipmentSizeDeterminer determiner = new ShipmentSizeManager();
        basket = new Basket(determiner);
    }
